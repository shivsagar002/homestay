                  ...
                  <div className="flex flex-col md:flex-row">
                    ...
                    <div className="flex-1 p-6 md:p-8">
                      ...
                      <div className="flex flex-wrap items-center gap-3 mt-8">
                        <a 
                          href={`tel:${booking.propertyId?.ownerContact}`}
                          className="flex items-center px-4 py-2 bg-gray-50 text-gray-700 rounded-xl hover:bg-gray-100 font-bold text-sm transition-all border border-gray-100"
                        >
                        ...
                        {booking.propertyId?.ownerWhatsApp && (
                          <a 
                            href={`https://wa.me/${booking.propertyId.ownerWhatsApp.replace(/\D/g, '')}`}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex items-center px-4 py-2 bg-emerald-50 text-emerald-700 rounded-xl hover:bg-emerald-100 font-bold text-sm transition-all border border-emerald-100"
                          >
                            <svg className="h-4 w-4 mr-2 shadow-sm" fill="currentColor" viewBox="0 0 24 24">
